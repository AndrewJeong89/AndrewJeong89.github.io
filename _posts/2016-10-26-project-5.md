...
In order to search for the optimal parameters of the logistic regression, a gridsearch was used to determine which penalty to use, L1 or L2 and which C value, between -5 and 50, outputs the  
