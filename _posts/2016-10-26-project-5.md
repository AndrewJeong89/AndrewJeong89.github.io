...
From there the data was converted to a dataframe. After looking at the data, it was determined that the column for cabin number was irrelevant in determing whether a passenger would survive a disaster. The cabin numbers were also random in the dataset. Therefore, the cabin column was dropped. 
